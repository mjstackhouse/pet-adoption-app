...
export default function ChangePageButton({ parameters, searchParameters }) {
  ...
  return (
    <div className='w-[100vw] sm:w-[900px] xl:w-[960px] xl:px-8 flex flex-wrap place-items-center text-center'>
      <h1 className={`${bree.className} basis-full font-bold text-3xl sm:text-4xl tracking-wide mb-4 sm:hidden`}>Continue looking by clicking below:</h1>
