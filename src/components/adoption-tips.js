...
export default function AdoptionTips() {
  return (
    // <div className='basis-full bg-yellow w-[100vw] mx-auto'>
      <div id='adoption-tips-container' className='relative flex flex-wrap text-center justify-center items-center my-auto h-[100vh] sm:h-[50vh] max-w-[900px] mx-auto'>
